...
#define L298N_in4 7  // Dir Motor B //8
#define L298N_in3 8  // Dir Motor B //7
#define L298N_in2 12  // Dir Motor A //13
#define L298N_in1 13  // Dir Motor A //12

// Wheel Encoders Connection PINs
#define right_encoder_phaseA 5  // Interrupt 
